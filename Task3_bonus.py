...
With the inclusion of U3 gates from the
main task, this task explores to use a variational
quantum algorithm to find the optimal parameter of an
objective function. As the task did not specify
what the cost of our objective function should be,
I set the cost equal to the number of times our quantum
state collapses into a certain classical state
after measurement.
The code outputs the optimal parameters: theta and phi
that minimizes cost. This problem is similar to a gradient
descent problem, and furthermore a quantum annealing problem.
